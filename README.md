...
* **Motor-Imagery**
  ...
  12. [Left/Right hand MI including Cognitive Factors](https://dataverse.nl/dataset.xhtml?persistentId=doi%3A10.34894%2FZ7ZVOD&version=&q=&fileTypeGroupFacet=&fileAccess=&fileSortField=size): 16-electrode data of 55 novice BCI users in a two-class left versus right hand motor imagery BCI task. There was one session with four runs of each 40 trials. Cognitive and Psychological tests that were administered: Demographics, Five Factor Personality Inventory, Vividness of Visual Imagery, Affinity for Technology Interaction Scale, Design Organization Test, Mental Rotation Test, and Questionnaire of Current Motivation. [[Article]](https://www.frontiersin.org/articles/10.3389/fnhum.2021.634748/full)
